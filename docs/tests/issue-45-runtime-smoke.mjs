...
await record(
    ...
    async () => {
        ...
        betterSubagents(pi);
        check(typeof handlers.session_start === "function", "session_start must register");
        check(typeof handlers.session_shutdown === "function", "session_shutdown must register");
